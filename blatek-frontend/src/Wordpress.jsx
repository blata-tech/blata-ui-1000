      ...
      >
        ...
        <div style={{
          ...
          <p style={{ marginTop: '0.3rem', fontSize: '1.1rem', color: '#444' }}>
            We specialize in WordPress and cPanel solutions that are:          </p>
          ...
          <p style={{ marginTop: '0.3rem', fontSize: '1.1rem', color: '#444' }}>
            We combine technical expertise with hands-on experience to provide reliable and hassle-free WordPress and cPanel administration. Our goal is to keep your website secure, optimized, and fully functional, allowing your business to thrive online.          </p>
          <strong style={{ marginTop: '1.5rem', fontSize: '1.1rem', color: '#444' }}>
