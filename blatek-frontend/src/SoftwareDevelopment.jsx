  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        <p style={{ marginTop: '0.3rem', fontSize: '1.1rem', color: '#444' }}>
          Whether you’re launching a startup, upgrading existing systems, or developing a new digital product, Blata Technology is your trusted partner for innovation, reliability, and success.
          Ready to turn your vision into reality? Contact us today to discuss your software development needs and discover how Blata Technology can help you achieve your business goals.
        </p>
      </div>
    </div>
  );
